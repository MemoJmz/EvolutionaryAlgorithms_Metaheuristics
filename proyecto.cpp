/* -----------------------------------------------------
*
*   Proyect: Metaheurísticas 
*   By: Guillermo Alberto Jimenez Frias
*   Date: June 03, 2024
*
*   Compilation:        g++ -O3 proyecto.cpp -o main
*   Execution:          main.exe
*
* ----------------------------------------------------- */
...
// Get samples of size N of uniform and normal distributions
...
// =================== Principal Functions ==================
// Funtion to evaluate populations
...
// Function to joint the best individuals as a new population
...
int main(int argc, char* argv[])
{
    ...
    double Eo_inf = 0.0;    // model parameters
    double Eo_sup = 0.5;
    double b_inf = 0.0;
    double b_sup = 0.2;
    double Re_inf = 0.0;
    ...
    // the time is measured starting here
